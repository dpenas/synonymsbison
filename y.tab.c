...
{
  "$end", "error", "$undefined", "SYNONYM", "SENSE", "$accept", "S",
  "thesaurus", "senses", "synonyms", 0
};
#endif
...
#line 86 "final.y"
  ...
  case 5:
#line 88 "final.y"
    {insertsenses((yyvsp[(2) - (2)].string));}
    break;

  case 6:
#line 89 "final.y"
    {insertsenses((yyvsp[(1) - (1)].string));}
    break;

  case 7:
#line 91 "final.y"
    {inserteverything((yyvsp[(2) - (2)].string));}
    break;
...
#line 93 "final.y"
  ...
  case 10:
#line 94 "final.y"
    {inserteverything((yyvsp[(1) - (1)].string));}
    break;
